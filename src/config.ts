...
export const siteConfig: SiteConfig = {
	...
	siteURL: "siteURL: https://piteawa.github.io/awa/", // 请替换为你的站点URL，以斜杠结尾
...
export const shareConfig: ShareConfig = {
	enable: false, // 启用分享功能。当设置为 false 时，分享组件将不会显示在文章区域，且不会加载分享组件使用的库
};
